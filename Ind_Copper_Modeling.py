...
class prediction:
    ...
    def regression():
        ...
        if button:
            ...
            with open('C:\\Users\\Mohan.S\\Desktop\\Mohan_Project\\Project5\\regression_model.pkl', 'rb') as f:
                model = pickle.load(f)
    ...
    def classification():
        ...
        if button:
            ...
            with open('C:\\Users\\Mohan.S\\Desktop\\Mohan_Project\\Project5\\classification_model.pkl', 'rb') as f:
                model = pickle.load(f)
